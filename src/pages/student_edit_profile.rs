    ...
    view! {
        <div class="edit-profile-container">
            ...
            <header class="edit-profile-header">
                ...
                <h1 class="edit-profile-title">"Profile"</h1>
            ...
            <div class="edit-profile-content">
                ...
                <div class="edit-profile-avatar-section">
                    <div class="edit-profile-avatar-container">
                        <img src="https://mockmind-api.uifaces.co/content/human/125.jpg" alt="Profile Avatar" class="edit-profile-avatar-img" />
                    ...
                    <h2 class="edit-profile-name">"Sarah Johnson"</h2>
                    <p class="edit-profile-subtitle">"Computer Science Student"</p>
                </div>
                ...
                <section class="edit-profile-section">
                    ...
                    <div class="edit-input-group">
                        <div class="edit-input-icon edit-icon-teal">
                    ...
                    <div class="edit-input-group">
                        ...
                        />
                        <button class="edit-input-action">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                {/* Confirm Button */}
                <button class="confirm-btn" on:click=handle_confirm>
                    "Confirm"
                </button>
            </div>
        </div>
