...
INSERT INTO classes (moduleCode, title, venue, description, recurring, date, time, duration_minutes, status, created_at, updated_at) VALUES
-- CS301 current and previous two months (approx W1..W4)
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','+6 days'),  '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','+13 days'), '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','+20 days'), '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','+27 days'), '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','-1 months','+6 days'),  '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','-1 months','+13 days'), '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','-1 months','+20 days'), '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','-1 months','+27 days'), '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','-2 months','+6 days'),  '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','-2 months','+13 days'), '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','-2 months','+20 days'), '10:00', 90, 'completed', datetime('now'), datetime('now')),
('CS301','DS Lecture','Hall A','Lecture','weekly', date('now','start of month','-2 months','+27 days'), '10:00', 90, 'completed', datetime('now'), datetime('now')),
-- CS302 current and previous two months (approx W1..W4)
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','+5 days'),  '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','+12 days'), '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','+19 days'), '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','+26 days'), '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','-1 months','+5 days'),  '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','-1 months','+12 days'), '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','-1 months','+19 days'), '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','-1 months','+26 days'), '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','-2 months','+5 days'),  '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','-2 months','+12 days'), '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','-2 months','+19 days'), '14:00', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Lecture','Hall B','Lecture','weekly', date('now','start of month','-2 months','+26 days'), '14:00', 90, 'completed', datetime('now'), datetime('now'));
...
INSERT INTO classes (moduleCode, title, venue, description, recurring, date, time, duration_minutes, status, created_at, updated_at) VALUES
('CS301','DS Extra Low Attendance','Hall A','Test low attendance','single', date('now','start of month','+9 days'), '09:00', 90, 'completed', datetime('now'), datetime('now'));
...
INSERT INTO classes (moduleCode, title, venue, description, recurring, date, time, duration_minutes, status, created_at, updated_at) VALUES
('CS301','DS Extra High Attendance','Hall A','Test high attendance','single', date('now','start of month','-1 months','+25 days'), '09:00', 90, 'completed', datetime('now'), datetime('now'));
...
INSERT INTO classes (moduleCode, title, venue, description, recurring, date, time, duration_minutes, status, created_at, updated_at) VALUES
('CS302','Web Dev Mixed','Hall B','Mixed attendance','single', date('now','start of month','-2 months','+18 days'), '15:00', 90, 'completed', datetime('now'), datetime('now'));
...
INSERT INTO classes (moduleCode, title, venue, description, recurring, date, time, duration_minutes, status, created_at, updated_at) VALUES
('CS301','DS Today','Hall A','Today session','single', date('now'), '10:30', 90, 'completed', datetime('now'), datetime('now')),
('CS302','Web Dev Today','Hall B','Today session','single', date('now'), '11:30', 90, 'completed', datetime('now'), datetime('now'));
